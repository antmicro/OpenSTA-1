...
public:
  ...
  virtual void visitTimingPathSourceClockTransition(LibertyAttr *attr);
  virtual void visitTimingPathTargetClock(LibertyAttr *attr);
  virtual void visitTimingPathTargetClockTransition(LibertyAttr *attr);
